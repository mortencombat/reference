/**
 * Some upstream sheets cite sources as `[[s]](url)`, which renders as a link
 * whose text is "[s]". Show those as a small external-link icon with a
 * "Source" tooltip instead.
 */
const ICON =
